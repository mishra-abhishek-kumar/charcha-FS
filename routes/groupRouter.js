...
router.post(
	"/create-group-users/:groupId",
	requiredUser,
	groupController.createGroupUSers
);
...
router.post(
	"/add-moreuser/:groupId",
	requiredUser,
	groupController.addMoreUserToGroup
);
router.post(
	"/send-image/:reciepientId",
	requiredUser,
	groupController.sendImageAsMessage
);
